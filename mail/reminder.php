...
<p>
    ...
    รายงานความก้าวหน้าโครงการวิจัยดังกล่าว ตามแบบฟอร์ม ภายในวันที่ <span style="font-weight:bold;margin-bottom:8px;"><?= Html::encode(ThaiDate::format($deadlineDate, false)) ?></span>
</p>
